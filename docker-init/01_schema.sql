-- Schema for the student_management database, loaded automatically by
-- docker-compose on first startup. Generated from database/schema.sql with
-- the CREATE DATABASE/USE lines removed (the container's MYSQL_DATABASE
-- environment variable selects the database instead).
--
-- Regenerate with:
--   grep -vE '^(CREATE DATABASE|USE )' database/schema.sql > docker-init/01_schema.sql
